...
const services = [
  {
    id: 1,
    title: 'Safety & Risk Assessment Trainings',
    ...
    link: '/Trainings&Auditing/SafetyRiskAssTrainings', // Link to specific page
  },
  {
    id: 2,
    title: 'ISO Management Trainings',
    description: 'Determine the required Safety Integrity Level for your systems.',
    icon: <HazeIcon className="w-12 h-12 text-primary" />,
    link: '/Trainings&Auditing/ISOManagementTrainings',
  },
  {
    id: 3,
    title: 'ESG and GHG Accounting',
    description: 'Helping organizations achieve their environmental, social, and governance goals.',
    icon: <HazeIcon className="w-12 h-12 text-primary" />,
    link: '/Trainings&Auditing/ESGandGHGAccounting',
  },
